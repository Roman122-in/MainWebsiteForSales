document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        de: {
            ...
            "plan120.main.header": "Fragebogen für Ihre Website (300 €)",
        ...
        en: {
            ...
            "plan120.main.header": "Questionnaire for Your Website (€300)",
    ...
    const templateFileMap = {
        minimalism: 'minimum120.html',
        corporate: 'corporativ120.html',
        creative: 'creativ120.html'
    };
    ...
    form.addEventListener('submit', function(event) {
        ...
        fetch('/submit-plan120', { method: 'POST', body: formData })
