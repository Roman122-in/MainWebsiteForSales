document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        de: {
            ...
            "plan120.main.header": "Fragebogen für Ihre Website (900 €)",
        ...
        en: {
            ...
            "plan120.main.header": "Questionnaire for Your Website (€900)",
    ...
    const templateFileMap = {
        minimalism: 'minimum360.html',
        corporate: 'corporativ360.html',
        creative: 'creativ360.html'
    };
    ...
    form.addEventListener('submit', function(event) {
        ...
        fetch('/submit-plan360', { method: 'POST', body: formData })
